...
public class Q2 extends TestBase {
    ...
    public void test(){
        ...
        System.out.println("****************TABLE DATA TOPLU************************");
        count=1;
        ...
        System.out.println("****************TUM CELL DATA HUCRE************************");
        count=1;
        ...
        for (WebElement each:eachElements
        ) {
    ...
    public String getData(int satir,int sutun){
        // String element1="//div[@class='rt-tbody']//div["+satir+"]//div["+sutun+"]";//Bu da kullanilabilirdi
        String element1="//div[@class='rt-tr-group']["+satir+"]/div/div["+sutun+"]";
        String don=driver.findElement(By.xpath(element1)).getText();
        return don;
    }
}
